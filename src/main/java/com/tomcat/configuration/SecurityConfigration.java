...
public class SecurityConfigration extends WebSecurityConfigurerAdapter{
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.csrf().disable()
			...
			.and().authorizeRequests().antMatchers("/admin/ticket-management").hasAnyRole("ADMIN","STAFF")
			.and().authorizeRequests().antMatchers("/admin/booking-management").hasAnyRole("ADMIN","STAFF")
			.and().authorizeRequests().antMatchers("/admin/customer-management").hasAnyRole("ADMIN","STAFF")
